...
<body>
    ...
    <div id="wrap" class="home">
				...
				<a class="fusion-logo-link" href="#">
						...
						<!-- standard logo -->
			<img src="templates/default/images/logo.png" srcset="templates/default/images/logo.png" width="336" height="56" alt="Atonomi Logo" retina_logo_url="" class="fusion-standard-logo">
		...
		<li role="menuitem" id="menu-item-81" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-81"><a href="<?php echo $rownav['linkurl']; ?>" class="fusion-bar-highlight" style="line-height: 104px; height: 107px;"><span class="menu-text"><?php echo $rownav['classname']; ?></span></a></li>
				<?php
				}
				?>
...
$("#but").click(function(){  
		...
		<div class="fusion-fullwidth fullwidth-box fusion-blend-mode video-background hundred-percent-fullwidth non-hundred-percent-height-scrolling" style="background-color: rgba(45,62,72,0.5);background-position: center top;background-repeat: no-repeat;">
		<div class="fullwidth-video-image" style="background-image:url(/uploads/image/CENTRI_hero-video_mobile-2.jpg);background-position:center;"></div>
		<div class="fullwidth-video">
		 <video preload="auto" autoplay="" loop="" muted=""><source src="/uploads/image/Atonomi-web-hero_best-quality.mp4" type="video/mp4"></video>  
		</div>
		...
		<a class="fusion-button button-flat fusion-button-pill button-large button-custom button-1" target="_self" ><span class="fusion-button-text">人工智能AI加入</span></a>
		</div>
		...
		<a class="fusion-button button-flat fusion-button-pill button-large button-custom button-2" target="_blank" rel="noopener noreferrer"><span class="fusion-button-text">白名单注册</span></a>
		...
		<div class="fusion-layout-column fusion_builder_column fusion_builder_column_1_1  fusion-one-full fusion-column-first fusion-column-lastest fusion-column-last 1_1" style="margin-top:300px;margin-bottom:0px;">
            ...
            <div class="container">
				...
				<?php $row1 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=1");?>	
		...
		<section id="services">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
					<?php $row2 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=2");?>	
            ...
            <div class="container">
                <div class="row">
				<?php $row4 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=4");?>
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
		...
		<section id="buyNow">
            <div class="container">
                <div class="row">
					...
					<?php $row5 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=5");?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
						<?php $row6 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=6");?>
				  ...
				  ?>	
                            ...
                            <div class="col-md-3">
                                <div class="media vertical scrollpoint sp-effect5">
                                    <a href="#">
                                        <i class="media-object fa fa-pencil fa-2x"></i>
                                    </a>
                                    <div class="media-body">
                            ...
                            <div class="col-md-3">
                                <div class="media vertical scrollpoint sp-effect5">
                                    <a href="#">
                                        <i class="media-object fa fa-code fa-2x"></i>
                                    </a>
                                    <div class="media-body">
        ...
        <section id="highlights">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
						<?php $row7 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=7");?>
        ...
        <section id="features">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7 scrollpoint sp-effect2">
					<?php $row09 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=9");?>
        ...
        <section id="skills">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
						<?php $row08 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=8");?>
				...
				<div class="fusion-layout-column fusion_builder_column fusion_builder_column_1_1  fusion-one-full fusion-column-first fusion-column-last 1_1" style="margin-top:0px;">
				<div class="fusion-column-wrapper" style="padding: 0px 0px 0px 0px;background-position:left top;background-repeat:no-repeat;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover;" data-bg-url="">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
						<?php $row010 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=10");?>
        ...
        <section id="team">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
						<?php $row011 = $dosql->GetOne("SELECT * FROM `#@__infoclass` WHERE `id`=11");?>
