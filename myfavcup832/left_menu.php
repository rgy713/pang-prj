...
<div id="scrollmenu">
	...
	<div class="viewport">
		<div class="overview">
			...
			<div class="hr_5"></div>
			<div class="menubox">
				<div class="title" onclick="DisplayMenu('leftmenu02');" title="点击切换显示或隐藏"> Content Manage </div>
				<div id="leftmenu02" style="display:none"> <a href="infoclass.php" target="main">Section Manage</a> <a href="maintype.php" target="main">Secondary Sec Manage</a>
					<div class="hr_1"> </div>
					<a href="info.php" target="main">Single Page</a> <a href="infolist.php" target="main">List Info</a> <a href="infoimg.php" target="main">Image Info</a> <a href="soft.php" target="main">软件下载管理</a>
					<div class="hr_1"> </div>
